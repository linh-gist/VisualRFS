...
def eval_seq(img_path, detector_path, result_filename, save_dir=None, frame_rate=30):
    data_type = 'mot'
    show_image = False
    if save_dir:
...
def demo(data_root, ismot20=False, result_dir="mot16_lmb_fairmot256", detector_dir="detector_fairmot256"):
    ...
    for seq in seqs_train:
        ...
        # eval_seq(img_path, detector_path, result_filename, save_dir=None, frame_rate=frame_rate)

        p = multiprocessing.Process(target=eval_seq,
                                    args=(img_path, detector_path, result_filename, None, frame_rate,))
        processes.append(p)
        p.start()
...
def mot17_eval(data_root, result_dir="mot16_lmb_cstrack", output_dir="mot17_lmb_cstrack"):
    # data_root = '/media/ubuntu/2715608D71CBF6FC/datasets/mot'
...
if __name__ == '__main__':
    data_root = '/media/ubuntu/2715608D71CBF6FC/datasets/mot'
    # demo(data_root, False, result_dir="mot16_lmb_fairmot256", detector_dir="detector_fairmot256")
    mot17_eval(data_root, result_dir="mot16_lmb_fairmot256", output_dir="mot17_lmb_fairmot256")
